...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("Lumia650Pkg",)
    ArchSupported = ("ARM")
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('Lumia650', 'edk2-build', 'cibuild')
    WorkspaceRoot = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    PackagesPath = ("Platforms", "MU_BASECORE", "Common/MU", "Common/MU_TIANO", "Common/MU_OEM_SAMPLE", "Silicon/ARM/TIANO", "Silicon/QC/Msm8909")
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("Lumia650Pkg/Lumia650.dsc", {})
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def AddCommandLineOptions(self, parserObj):
        ...
        parserObj.add_argument('-a', "--arch", dest="build_arch", type=str, default="ARM",
            help="Optional - CSV of architecture to build. ARM will use ARM for PEI and "
            "ARM for DXE and is the only valid option for this platform.")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "Lumia650", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "Lumia650Pkg/Lumia650.dsc", "Platform Hardcoded")
